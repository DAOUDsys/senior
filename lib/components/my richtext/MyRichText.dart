...
class MyRichText extends StatelessWidget {
  MyRichText({Key? key, required this.text1,required this.text2,required this.width,required this.height,}) : super(key: key);
  String text1;
  String text2;
  double width;
  double height;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(child: RichText(text: TextSpan(children: [
                  TextSpan(text:text1, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,
                  color: DefaultTextStyle.of(context).style.color),),
                  TextSpan(text: text2, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,
